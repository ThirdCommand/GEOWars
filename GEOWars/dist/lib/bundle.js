...
const BoxBox = __webpack_require__(/*! ./game_objects/enemies/BoxBox/boxbox */ "./src/game_objects/enemies/BoxBox/boxbox.js");
const Pinwheel = __webpack_require__(/*! ./game_objects/enemies/Pinwheel/pinwheel */ "./src/game_objects/enemies/Pinwheel/pinwheel.js");
const Arrow = __webpack_require__(/*! ./game_objects/enemies/Arrow/arrow */ "./src/game_objects/enemies/Arrow/arrow.js");
const Grunt = __webpack_require__(/*! ./game_objects/enemies/Grunt/grunt */ "./src/game_objects/enemies/Grunt/grunt.js");
const Weaver = __webpack_require__(/*! ./game_objects/enemies/Weaver/weaver */ "./src/game_objects/enemies/Weaver/weaver.js");
const Singularity = __webpack_require__(/*! ./game_objects/enemies/Singularity/singularity */ "./src/game_objects/enemies/Singularity/singularity.js");
const AlienShip = __webpack_require__(/*! ./game_objects/enemies/Singularity/alien_ship */ "./src/game_objects/enemies/Singularity/alien_ship.js")
...
// save spawn event
// create spawn event
const GameObject = __webpack_require__(/*! ../../../game_engine/game_object */ "./src/game_engine/game_object.js");

const PlacingAnimation = __webpack_require__(/*! ./PlacingAnimation */ "./src/game_engine/Levels/LevelDesign/PlacingAnimation.js")
const BoxBoxSprite = __webpack_require__(/*! ../../../game_objects/enemies/BoxBox/boxbox_sprite */ "./src/game_objects/enemies/BoxBox/boxbox_sprite.js")
const ArrowSprite = __webpack_require__(/*! ../../../game_objects/enemies/Arrow/arrow_sprite */ "./src/game_objects/enemies/Arrow/arrow_sprite.js")
const GruntSprite = __webpack_require__(/*! ../../../game_objects/enemies/Grunt/grunt_sprite */ "./src/game_objects/enemies/Grunt/grunt_sprite.js")
const PinwheelSprite = __webpack_require__(/*! ../../../game_objects/enemies/Pinwheel/pinwheel_sprite */ "./src/game_objects/enemies/Pinwheel/pinwheel_sprite.js")
const WeaverSprite = __webpack_require__(/*! ../../../game_objects/enemies/Weaver/weaver_sprite */ "./src/game_objects/enemies/Weaver/weaver_sprite.js")
const SingularitySprite = __webpack_require__(/*! ../../../game_objects/enemies/Singularity/singularity_sprite */ "./src/game_objects/enemies/Singularity/singularity_sprite.js")
...
class PlacingAnimation extends GameObject{
  constructor(engine){
    super(engine)
  ...
  update(timeDelta) {
    ...
    if (this.parentObject.lineSprite.spawningScale < 0.7){
      ...
      this.parentObject.lineSprite.spawningScale -= this.cycleSpeed * cycleSpeedScale;
    }
  }
  
}
const NORMAL_FRAME_TIME_DELTA = 1000 / 60;
module.exports = PlacingAnimation;
...
const Walls = __webpack_require__(/*! ../../game_objects/Walls/walls */ "./src/game_objects/Walls/walls.js")
const Overlay = __webpack_require__(/*! ../../game_objects/Overlay/overlay */ "./src/game_objects/Overlay/overlay.js")
const Grid = __webpack_require__(/*! ../../game_objects/particles/Grid/grid */ "./src/game_objects/particles/Grid/grid.js")
const EnemyPlacer = __webpack_require__(/*! ../Levels/LevelDesign/EnemyPlacer */ "./src/game_engine/Levels/LevelDesign/EnemyPlacer.js");

const {Spawn, GameSequence, GameSequenceDisplay, Event, Operation, Scene} = __webpack_require__(/*! ./scene */ "./src/game_engine/Levels/scene.js");
...
const Util = __webpack_require__(/*! ./util */ "./src/game_engine/util.js")
...
const GameScript = __webpack_require__(/*! ../game_script */ "./src/game_script.js");
...
const Util = __webpack_require__(/*! ./util */ "./src/game_engine/util.js");
const Sound = __webpack_require__(/*! ./sound */ "./src/game_engine/sound.js")

const Transform = __webpack_require__( /*! ./transform */ "./src/game_engine/transform.js")
const PhysicsComponent = __webpack_require__(/*! ./physics_component */ "./src/game_engine/physics_component.js")
const LineSprite = __webpack_require__(/*! ./line_sprite */ "./src/game_engine/line_sprite.js")
const Collider = __webpack_require__(/*! ./collider */ "./src/game_engine/collider.js")
...
class GameObject {
  ...
  addCollider(type, gameObject, radius, subscriptionTypes, subscriptions){
    ...
    const newCollider = new Collider(type, gameObject, radius, subscriptionTypes, subscriptions)
...
const GameObject = __webpack_require__(/*! ./game_object */ "./src/game_engine/game_object.js")
...
const GameObject = __webpack_require__(/*! ../../game_engine/game_object */ "./src/game_engine/game_object.js");
const Sound = __webpack_require__(/*! ../../game_engine/sound */ "./src/game_engine/sound.js")
const BulletWallExplosion = __webpack_require__(/*! ../particles/bullet_wall_explosion */ "./src/game_objects/particles/bullet_wall_explosion.js")
const BulletSprite = __webpack_require__(/*! ./bullet_sprite */ "./src/game_objects/Bullet/bullet_sprite.js")
const ParticleExplosion = __webpack_require__(/*! ../particles/particle_explosion */ "./src/game_objects/particles/particle_explosion.js")
...
const LineSprite = __webpack_require__(/*! ../../game_engine/line_sprite */ "./src/game_engine/line_sprite.js")
...
const OverlaySprite = __webpack_require__(/*! ./overlay_sprite */ "./src/game_objects/Overlay/overlay_sprite.js")
const GameObject = __webpack_require__(/*! ../../game_engine/game_object */ "./src/game_engine/game_object.js")
...
const LineSprite = __webpack_require__(/*! ../../game_engine/line_sprite */ "./src/game_engine/line_sprite.js")
const Color = __webpack_require__(/*! ../../game_engine/color */ "./src/game_engine/color.js")
...
const WallsSprite = __webpack_require__(/*! ./walls_sprite */ "./src/game_objects/Walls/walls_sprite.js")
const GameObject = __webpack_require__(/*! ../../game_engine/game_object */ "./src/game_engine/game_object.js")
...
const GameObject = __webpack_require__(/*! ../../../game_engine/game_object */ "./src/game_engine/game_object.js");
const Util = __webpack_require__(/*! ../../../game_engine/util */ "./src/game_engine/util.js");
const Sound = __webpack_require__(/*! ../../../game_engine/sound */ "./src/game_engine/sound.js");

const EnemySpawn = __webpack_require__(/*! ../../particles/enemy_spawn */ "./src/game_objects/particles/enemy_spawn.js");
const ArrowSprite = __webpack_require__(/*! ./arrow_sprite */ "./src/game_objects/enemies/Arrow/arrow_sprite.js");
...
const EnemySpawn = __webpack_require__(/*! ../../particles/enemy_spawn */ "./src/game_objects/particles/enemy_spawn.js")
const BoxBoxSprite = __webpack_require__(/*! ./boxbox_sprite */ "./src/game_objects/enemies/BoxBox/boxbox_sprite.js")
...
const EnemySpawn = __webpack_require__(/*! ../../particles/enemy_spawn */ "./src/game_objects/particles/enemy_spawn.js")
const GruntSprite = __webpack_require__(/*! ./grunt_sprite */ "./src/game_objects/enemies/Grunt/grunt_sprite.js")
...
const EnemySpawn = __webpack_require__(/*! ../../particles/enemy_spawn */ "./src/game_objects/particles/enemy_spawn.js")
const PinwheelSprite = __webpack_require__(/*! ./pinwheel_sprite */ "./src/game_objects/enemies/Pinwheel/pinwheel_sprite.js")
...
const AlienShipSprite = __webpack_require__(/*! ./alien_ship_sprite */ "./src/game_objects/enemies/Singularity/alien_ship_sprite.js")
...
const ParticleExplosion = __webpack_require__(/*! ../../particles/particle_explosion */ "./src/game_objects/particles/particle_explosion.js")
const SingularityHitExplosion = __webpack_require__(/*! ../../particles/singularity_hit_explosion */ "./src/game_objects/particles/singularity_hit_explosion.js")

const EnemySpawn = __webpack_require__(/*! ../../particles/enemy_spawn */ "./src/game_objects/particles/enemy_spawn.js")
const SingularitySprite = __webpack_require__(/*! ./singularity_sprite */ "./src/game_objects/enemies/Singularity/singularity_sprite.js")
const SingularityParticles = __webpack_require__(/*! ../../particles/singularity_particles */ "./src/game_objects/particles/singularity_particles.js")
const AlienShip = __webpack_require__(/*! ./alien_ship */ "./src/game_objects/enemies/Singularity/alien_ship.js")
...
const EnemySpawn = __webpack_require__(/*! ../../particles/enemy_spawn */ "./src/game_objects/particles/enemy_spawn.js")
const WeaverSprite = __webpack_require__(/*! ./weaver_sprite */ "./src/game_objects/enemies/Weaver/weaver_sprite.js")
...
const GridSprite = __webpack_require__(/*! ./grid_sprite */ "./src/game_objects/particles/Grid/grid_sprite.js")
const GridPoint = __webpack_require__(/*! ./grid_point */ "./src/game_objects/particles/Grid/grid_point.js")
...
const ParticleSprite = __webpack_require__(/*! ./particle_sprite */ "./src/game_objects/particles/Particle/particle_sprite.js")
...
/***/ "./src/game_objects/particles/Singularity_Particle/singulairty_particle_sprite.js":
/*!****************************************************************************************!*\
  !*** ./src/game_objects/particles/Singularity_Particle/singulairty_particle_sprite.js ***!
  \****************************************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
const LineSprite = __webpack_require__(/*! ../../../game_engine/line_sprite */ "./src/game_engine/line_sprite.js")
const ParticleSprite = __webpack_require__(/*! ../Particle/particle_sprite */ "./src/game_objects/particles/Particle/particle_sprite.js")
...
//
// 
const SingularityParticleSprite = __webpack_require__(/*! ./singulairty_particle_sprite */ "./src/game_objects/particles/Singularity_Particle/singulairty_particle_sprite.js")

const Util = __webpack_require__(/*! ../../../game_engine/util */ "./src/game_engine/util.js")
const GameObject = __webpack_require__(/*! ../../../game_engine/game_object */ "./src/game_engine/game_object.js")
const Particle = __webpack_require__(/*! ../Particle/particle */ "./src/game_objects/particles/Particle/particle.js")
...
const GameObject = __webpack_require__(/*! ../../game_engine/game_object */ "./src/game_engine/game_object.js")
const Util = __webpack_require__(/*! ../../game_engine/util */ "./src/game_engine/util.js")
const SingularityParticle = __webpack_require__(/*! ./Singularity_Particle/singularity_particle */ "./src/game_objects/particles/Singularity_Particle/singularity_particle.js")
const Color = __webpack_require__(/*! ../../game_engine/color */ "./src/game_engine/color.js")
...
const Bullet = __webpack_require__(/*! ../Bullet/bullet */ "./src/game_objects/Bullet/bullet.js");
const ShipSprite = __webpack_require__(/*! ./ship_sprite */ "./src/game_objects/ship/ship_sprite.js")
...
const Ship = __webpack_require__(/*! ./game_objects/ship/ship */ "./src/game_objects/ship/ship.js");
const Walls = __webpack_require__(/*! ./game_objects/Walls/walls */ "./src/game_objects/Walls/walls.js")
const Overlay = __webpack_require__(/*! ./game_objects/Overlay/overlay */ "./src/game_objects/Overlay/overlay.js")
const Grid = __webpack_require__(/*! ./game_objects/particles/Grid/grid */ "./src/game_objects/particles/Grid/grid.js")
const BoxBox = __webpack_require__(/*! ./game_objects/enemies/BoxBox/boxbox */ "./src/game_objects/enemies/BoxBox/boxbox.js");
...
const Singularity = __webpack_require__(/*! ./game_objects/enemies/Singularity/singularity */ "./src/game_objects/enemies/Singularity/singularity.js");
const AlienShip = __webpack_require__(/*! ./game_objects/enemies/Singularity/alien_ship */ "./src/game_objects/enemies/Singularity/alien_ship.js")
const ParticleExplosion = __webpack_require__(/*! ./game_objects/particles/particle_explosion */ "./src/game_objects/particles/particle_explosion.js")
const ShipExplosion = __webpack_require__(/*! ./game_objects/particles/ship_explosion */ "./src/game_objects/particles/ship_explosion.js")

const Util = __webpack_require__(/*! ./game_engine/util */ "./src/game_engine/util.js");
const Sound = __webpack_require__(/*! ./game_engine/sound */ "./src/game_engine/sound.js")
const StateMachine = __webpack_require__(/*! ./game_engine/state_machine */ "./src/game_engine/state_machine.js")
...
class GameScript {
  ...
  explodeEverything(){
    const removeList = []
    const typesToRemove = ["Grunt", "Pinwheel", "BoxBox", "Arrow", "Singularity", "Weaver", "AlienShip"]
...
const GameEngine = __webpack_require__(/*! ./game_engine/game_engine */ "./src/game_engine/game_engine.js");
const LevelDesigner = __webpack_require__(/*! ./game_engine/Levels/levelDesigner */ "./src/game_engine/Levels/levelDesigner.js");
const AnimationView = __webpack_require__(/*! ./AnimationView */ "./src/AnimationView.js");
