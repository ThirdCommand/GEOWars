...
export class TargetBuilding extends GameObject {
    radius: number;
    lineSprite: TargetBuildingSprite;
    lives: number;
    isAlive: boolean;
    ...
    constructor(engine: GameEngine | AnimationView, pos: [number, number]) {
        ...
        this.addLineSprite(new TargetBuildingSprite(this.transform));
    }
...
export class TargetBuildingSprite extends LineSprite {
    ...
    drawTargetBuilding(ctx: CanvasRenderingContext2D){
